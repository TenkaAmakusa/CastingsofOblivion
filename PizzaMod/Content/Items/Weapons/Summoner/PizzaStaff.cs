...
namespace PizzaMod.Content.Items.Weapons.Summoner
{
	...
	public class PizzaStaffBuff : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex) {
			...
			if (player.ownedProjectileCounts[ModContent.ProjectileType<PizzaMinion>()] > 0) {
	...
	public class PizzaStaff : ModItem
	{
		public override void SetStaticDefaults() {
			...
			ItemID.Sets.StaffMinionSlotsRequired[Type] = 0.01f; // The default value is 1, but other values are supported. See the docs for more guidance. 
		}
		...
		public override void SetDefaults() {
			...
			Item.buffType = ModContent.BuffType<PizzaStaffBuff>();
			// No buffTime because otherwise the item tooltip would say something like "1 minute duration"
			Item.shoot = ModContent.ProjectileType<PizzaMinion>(); // This item creates the minion projectile
		}
	...
	public class PizzaMinion : ModProjectile
	{
		public override void SetStaticDefaults() {
		...
		private bool CheckActive(Player owner) {
			if (owner.dead || !owner.active) {
				owner.ClearBuff(ModContent.BuffType<PizzaStaffBuff>());

				return false;
			}

			if (owner.HasBuff(ModContent.BuffType<PizzaStaffBuff>())) {
		...
		private void Visuals() {
			...
			Projectile.rotation = Projectile.velocity.X * 2.05f;
